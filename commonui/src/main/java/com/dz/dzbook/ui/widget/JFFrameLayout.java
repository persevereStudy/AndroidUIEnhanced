 ...
 * FrameLayout增强
 */
public class JFFrameLayout extends FrameLayout implements
        ShapeModelView,
        ShadowView,
        StrokeView,
        GradientView {
    ...
    public JFFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JFFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
