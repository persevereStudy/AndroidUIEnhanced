 ...
 * TextView增强
 */
public class JFTextView extends AppCompatTextView implements
        ShapeModelView,
        ShadowView,
        StrokeView,
        GradientView {
    ...
    public JFTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JFTextView(Context context, AttributeSet attrs, int defStyleAttr) {
