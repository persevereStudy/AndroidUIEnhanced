 ...
 * LinearLayout增强
 */
public class JFLinearLayout extends LinearLayoutCompat implements
        ShapeModelView,
        ShadowView,
        StrokeView,
        GradientView {
    ...
    public JFLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JFLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(AttributeSet attrs, int defStyleAttr) {
        ...
        viewEnhanceHelper.readAttrs(attrs, R.styleable.JFFrameLayout, defStyleAttr);
    }
