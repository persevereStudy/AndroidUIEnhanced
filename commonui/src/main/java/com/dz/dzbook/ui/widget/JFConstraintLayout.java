 ...
 * ConstraintLayout增强
 */
public class JFConstraintLayout extends ConstraintLayout implements
        ShapeModelView,
        ShadowView,
        StrokeView,
        GradientView {
    ...
    public JFConstraintLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JFConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(AttributeSet attrs, int defStyleAttr) {
        ...
        viewEnhanceHelper.readAttrs(attrs, R.styleable.JFConstraintLayout, defStyleAttr);
    }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        if (child instanceof ShadowView && (!JFAttrReader.IS_PIE_OR_HIGHER && ((ShadowView) child).getElevationShadowColor() != null)) {
