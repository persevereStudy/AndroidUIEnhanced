 ...
 */
public class JFView extends AppCompatTextView implements
        ShapeModelView,
        ShadowView,
        StrokeView,
        GradientView {
    ...
    public JFView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JFView(Context context, AttributeSet attrs, int defStyleAttr) {
