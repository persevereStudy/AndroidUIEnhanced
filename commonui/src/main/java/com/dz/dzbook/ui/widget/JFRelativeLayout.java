 ...
 * RelativeLayout增强
 */
public class JFRelativeLayout extends RelativeLayout  implements
        ShapeModelView,
        ShadowView,
        StrokeView,
        GradientView {
    ...
    public JFRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JFRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(AttributeSet attrs, int defStyleAttr) {
        ...
        viewEnhanceHelper.readAttrs(attrs, R.styleable.JFRelativeLayout, defStyleAttr);
    }
